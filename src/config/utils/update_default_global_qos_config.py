...
class SetDefaultGlobalQos(object):
    def __init__(self, args_str=None):
        ...
        value = ControlTrafficDscpType(
            control=self._args.control,
            analytics=self._args.analytics,
            dns=self._args.dns)
    ...
    def _parse_args(self, args_str):
        '''
        Eg. python update_default_global_qos_config.py
                --control 0x2c --analytics 0x38 --dns 0x40
        '''
        ...
        parser.add_argument("--control", type=auto_int,
                            help="DSCP value for control traffic")
        parser.add_argument("--analytics", type=auto_int,
                            help="DSCP value for analytics traffic")
        parser.add_argument("--dns", type=auto_int,
                            help="DSCP value for DNS traffic")
