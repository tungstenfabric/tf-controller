...
from vnc_api.vnc_api import PortTranslationPool
from vnc_api.vnc_api import PortTranslationPools
        ...
        for pool_obj in existing_snat_pools.get_port_translation_pool():
            if snat_pool.get_port_count() and pool_obj.get_port_count():
                ...
                if (snat_pool.get_protocol() == pool_obj.get_protocol() and
                        snat_pool.get_port_range().start_port ==
                        pool_obj.get_port_range().start_port and
                        snat_pool.get_port_range().end_port ==
                        pool_obj.get_port_range().end_port):
                    return True
        return False
