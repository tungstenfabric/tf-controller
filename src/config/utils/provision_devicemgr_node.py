...
from vnc_api.vnc_api import DevicemgrNode


class DevicemgrNodeProvisioner(object):
    ...
    def _parse_args(self, args_str):
        '''
        Eg. python provision_devicemgr_node.py
        ...
        parser.add_argument(
            "--host_name",
            help="hostname name of devicemgr node",
            required=True)
        parser.add_argument(
            "--host_ip", help="IP address of devicemgr node", required=True)
