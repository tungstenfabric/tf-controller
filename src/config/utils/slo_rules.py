...
class RulesToFromSLO(object):
    ...
    def _parse_args(self, args_str):
        ...
        parser.add_argument("--oper", choices=['associate', 'disassociate'],
                            help="operation type - associate/disassociate network-policy/SG with SLO")
        parser.add_argument(
            "--slo_fq_name", help="Fully qualified name of Security logging object", required=True)
        parser.add_argument(
            "--sg_fq_name", help="Fully qualified name of Security Group object")
        parser.add_argument(
            "--policy_fq_name", help="Fully qualified name of Network policy object")
        parser.add_argument(
            "--rules", help="json as {\"rule-uuid2\": rate1, \"rule-uuid2\": rate2}")
