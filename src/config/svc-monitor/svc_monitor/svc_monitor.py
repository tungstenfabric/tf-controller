...
class SvcMonitor(object):
    ...
    def post_init(self, vnc_lib, args=None):
        ...
        if not(self._init_db or DBBaseSM._object_db):
            DBBaseSM.init(None, None, self._object_db)
...
def analytics_api_ssl_params(args):
    return {'ssl_enable': args.analytics_api_ssl_enable,
            'insecure_enable': args.analytics_api_insecure_enable,
            'ca_cert': args.analytics_api_ssl_ca_cert,
            'keyfile': args.analytics_api_ssl_keyfile,
            'certfile': args.analytics_api_ssl_certfile}
