from .assert_dictionaries import check_subset_dictionaries
...
class FakeCCClient:
    ...
    The workflow looks like this:
        ...
        5. CC Client returns specified response that corresponds with
    ...
    def create_cc_resource(self, res_request_payload):
        ...
        for i, r in enumerate(self.__accept_requests):
            ...
            if not check_subset_dictionaries(r.payload, res_request_payload):
                continue
