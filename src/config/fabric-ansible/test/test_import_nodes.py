...
from .utils.assert_dictionaries import assert_subset_dictionaries
from .utils.fake_cc_client import CreateAcceptRequest
from .utils.fake_cc_client import FakeCCClient
from .utils.fake_cc_client import GetAcceptRequest
sys.path.append('../')
sys.path.insert(0, '../ansible-playbooks/filter_plugins/')
sys.path.append('../ansible-playbooks/')
...
class TestImportNodes(unittest.TestCase):
    ...
    def test_single_node_without_ports(self):
        ...
        assert_subset_dictionaries(expected_response[0], response[0])
