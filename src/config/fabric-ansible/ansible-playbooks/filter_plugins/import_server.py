...
class FilterModule(object):
    ...
    def import_nodes(self, data, cc_client):
        ...
        _unwrap_list_of_nested_resources(existing_nodes)
        _unwrap_list_of_nested_resources(existing_ports)
        _unwrap_list_of_nested_resources(existing_tags)
