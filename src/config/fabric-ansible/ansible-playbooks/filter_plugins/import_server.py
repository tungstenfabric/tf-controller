...
class FilterModule(object):
    ...
    def import_nodes(self, data, cc_client):
        ...
        for node in nodes:
            ...
            if len(response) > 1:
                self._logger.warning("Expected 1 node created. Got: {}.\n'{}'".format(len(response), pprint.pformat(response)))
            ...
            self._logger.warning("My problem is : " + pprint.pformat(response[0]['data']))
	...
	self._logger.warning("PORTUNIE: " + pprint.pformat(converted_ports))
