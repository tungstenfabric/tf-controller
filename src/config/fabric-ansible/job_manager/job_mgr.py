...
class JobManager(object):
    ...
    def __init__(self, logger, vnc_api, job_input, job_log_utils, job_template,
        ...
        self.job_execution_id = None
        self.job_transaction_id = job_transaction_id
        self.job_transaction_descr = job_transaction_descr
        self.job_data = None
    ...
    def start_job(self):
        ...
        try:
            ...
            while pb_idx < len(playbook_list):
                ...
                if should_cleanup and not play_info.recovery_playbook:
                ...
                if should_cleanup and play_info.recovery_playbook:
                ...
                while True:
                    job_mgr = JobManager(self._logger, self._vnc_api,
                                         ...
                                         pb_idx, job_percent, self._zk_client,
                                         self.job_description,
                                         self.job_transaction_id,
                                         self.job_transaction_descr)
            ...
            if should_cleanup and did_cleanup:
