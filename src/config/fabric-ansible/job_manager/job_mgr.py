    ...
    def start_job(self):
        ...
        try:
            ...
            while pb_idx < len(playbook_list):
                ...
                if cleanup_in_progress and not play_info.recovery_playbook:
                ...
                if cleanup_in_progress and play_info.recovery_playbook:
            ...
            if cleanup_in_progress and cleanup_completed:
