...
class LogicalRouterServer(ResourceMixin, LogicalRouter):
            ...
            try:
                ...
                # Might be validation error or stale
                    ...
                    try:
                        ...
                        exis_lr_fqname_str = lr_fqname_list[-1]
                        # NOT STALE chk
                        ...
                        is_vn_referred, err_obj = \
                            cls.is_vn_fab_referred_by_lr(
                                db_conn, vn_ref, fabric_uuid, exis_lr_fqname_str)
    ...
    def _check_and_associate_logical_router_vn(cls, db_conn, obj_dict,
        ...
        if fab_refs:
            ...
            if not vns_not_in_another_lr:
                ...
                if result == 404:
                    return vns_not_in_another_lr, results
                ...
                return vns_not_in_another_lr, (400, err_msg)
    ...
    def pre_dbe_create(cls, tenant_name, obj_dict, db_conn):
        ...
        ok, result, _ = cls._check_and_associate_logical_router_vn(db_conn,
                                                                obj_dict)
        if not ok:
            return ok, result
