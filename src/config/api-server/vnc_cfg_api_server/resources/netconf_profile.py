...
class NetconfProfileServer(ResourceMixin, NetconfProfile):
    ...
    def pre_dbe_update(cls, id, fq_name, obj_dict, db_conn, **kwargs):
        ...
        already_default = db_obj_dict.get('netconf_profile_is_default')

        is_default_profile = already_default if already_default is True \
            else obj_dict.get('netconf_profile_is_default')
    ...
    def pre_dbe_delete(cls, id, obj_dict, db_conn):
        ...
        is_default_profile = obj_dict.get('netconf_profile_is_default')

        np_fq_name = obj_dict.get('fq_name')
        ok, result = cls.is_crud_allowed(is_default_profile, np_fq_name)
