...
class VirtualPortGroupST(ResourceBaseST):
    ...
    @classmethod
    def reinit(cls):
        # TODO(dji): test restart schema VM is not deleted
        # TODO(dji): 'm:annotations:usage' is the correct column to read, but it is not in prop_fields of 'vnc_api.gen.resource_client.VirtualPortGroup'
