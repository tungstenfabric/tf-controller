...
class VirtualPortGroupST(ResourceBaseST):
    ...
    def update_physical_interfaces(self):
        self._logger.info("Starts upadting physical interfaces")
        new_pis = set()
        ...
        self._logger.info("Finished upadting physical interfaces")
    # end update_physical_interfaces

    def validate_virtual_port_group(self):
        self._logger.info("Starts validating virtual port group")
