...
class VirtualMachineInterfaceST(ResourceBaseST):
    ...
    def get_physical_interface(self, switch_id, switch_port_id):
        ...
        for physical_router_uuid in physical_router_uuids:
            ...
            physical_interface_uuids = self.get_uuids(physical_router.get_physical_interfaces())
            for physical_interface_uuid in physical_interface_uuids:
                physical_interface = self._vnc_lib.physical_interface_read(id=physical_interface_uuid)
    ...
    def get_uuids(self, dictionaries):
        return [dictionary['uuid'] for dictionary in dictionaries]
    # end get_uuids
