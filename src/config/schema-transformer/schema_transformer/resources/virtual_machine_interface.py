...
class VirtualMachineInterfaceST(ResourceBaseST):
    ...
    def process_vpg(self):
        self._logger.info("Process VPG collecting information"
                          "of vlan_id and physical interface")
        vlan_id, pi = \
            self.collect_vlan_id_and_physical_interface()
        self._logger.info("Process VPG collected vlan_id: %s "
                          "and physical interface: %s"
                          % (vlan_id, pi.get_fq_name_str()))
    ...
    def collect_vlan_id_and_physical_interface(self):
        ...
        self._logger.info("Collected physnet: %s, "
        ...
        self._logger.info("Collected switch_id: %s, "
        ...
        self._logger.info("Collected physical_interface: %s"
