...
class SchemaTransformer(object):
    ...
    def reinit(self):
        ...
        self.logger.info('VirtualPortGroupST - REINIT Start')
        VirtualPortGroupST.reinit()
        self.logger.info('VirtualPortGroupST - REINIT Complete')
        gevent.sleep(0.001)
