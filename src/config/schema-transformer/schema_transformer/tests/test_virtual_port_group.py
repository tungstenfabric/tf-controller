...
class TestVPG(STTestCase):
    ...
    def _pre_create_physical_router(self):
        physical_router = PhysicalRouter('test-physical-router')
        ...
        physical_interface_green = PhysicalInterface(
            'test-physical-interface-green', parent_obj=self.physical_router)
    ...
    def _pre_create_node(self):
        ...
        node_red = Node('test-node-red', node_hostname=self.node_red_hostname)
        ...
        port_red = Port('test-port-red', node_red, bms_port_info=bm_info)
        ...
        node_green = Node(
            'test-node-green', node_hostname=self.node_green_hostname)
        ...
        bm_info = BaremetalPortInfo(
            local_link_connection=local_link_connection)
        port_green = Port('test-port-green', node_green, bms_port_info=bm_info)
    ...
    def _pre_create_virtual_router(self):
        ...
        virtual_router_red = VirtualRouter('test-virtual-router-red')
        ...
        virtual_router_green = VirtualRouter('test-virtual-router-green')
    ...
    def _pre_create_virtual_networks(self):
        ...
        virtual_network_red = VirtualNetwork('test-virtual-network-red')
        ...
        virtual_network_green = VirtualNetwork('test-virtual-network-green')
        ...
        virtual_network_blue = VirtualNetwork('test-virtual-network-blue')
    ...
    def test_create_vmi(self):
        vmi = VirtualMachineInterface('test-tvirtual-machine-interface')
    ...
    def test_create_vmi_and_delete(self):
        vmi = VirtualMachineInterface('test-virtual-machine-interface-red')
        vmi.set_virtual_network(self.virtual_network_red)
        vmi.set_virtual_machine_interface_bindings(
            KeyValuePairs(
                key_value_pair=[KeyValuePair(key='vnic_type', value='direct'),
    ...
    def test_update_vmi_host(self):
        vmi = VirtualMachineInterface('test-virtual-machine-interface')
        vmi.set_virtual_network(self.virtual_network_red)
        vmi.set_virtual_machine_interface_bindings(
            KeyValuePairs(
                key_value_pair=[KeyValuePair(key='vnic_type', value='direct'),
