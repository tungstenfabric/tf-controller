...
void AgentStatsReq::HandleRequest() const {
    ...
    srsp->set_session_global_slo_logging_drops(agent->flow_stats_manager()->
                                            session_global_slo_logging_drops());
    srsp->set_session_slo_logging_drops(agent->flow_stats_manager()->
                                            session_slo_logging_drops());
