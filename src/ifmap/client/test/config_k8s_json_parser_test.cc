...
TEST_F(ConfigK8sJsonParserTest, BulkSync)
{
    ...
    // TODO: Add test for propagation of all fields (including description).
...
// Verify that ref objects are parsed
TEST_F(ConfigK8sJsonParserTest, ServerParserRefParsing)
{
    ParseEventsJson(
        "controller/src/ifmap/testdata/k8s_server_parser_test_refs.json");
    FeedEventsJson();
    task_util::WaitForIdle();
    FeedEventsJson();
}
