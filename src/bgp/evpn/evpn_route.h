...
public:
    ...
    const IpAddress& addr() const { return ip_address_; }
    ...
    const Ip4Address ip4_addr() const { return ip_address_.to_v4(); }
    const Ip6Address ip6_addr() const { return ip_address_.to_v6(); }
